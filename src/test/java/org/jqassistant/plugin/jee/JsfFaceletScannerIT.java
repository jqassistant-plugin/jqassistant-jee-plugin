...
import org.jqassistant.plugin.jee.api.model.JsfFaceletDescriptor;
...
class JsfFaceletScannerIT extends AbstractJavaPluginIT {
    ...
    private void scanFaceletDirectory() throws IOException {
        final File faceletDirectory = new File(getClassesDirectory(JsfFaceletScannerIT.class), "jee/facelet");
