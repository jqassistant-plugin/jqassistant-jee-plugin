...
public class InjectionIT extends AbstractJavaPluginIT {
    ...
    private static Stream<Arguments> beanProducerWithConstraintViolationsAndInjectablesAndApplicationResource() {
        return Stream.of(
                Arguments.of(JavaxBeanProducerWithConstraintViolations.class, JavaxInjectableA.class, JavaxInjectableB.class,
                        JavaxInjectableC.class, JavaxInjectableD.class, JavaxApplicationResource.class, JavaxNonCdiOrEjbInjectable.class),
                Arguments.of(JakartaBeanProducerWithConstraintViolations.class, JakartaInjectableA.class, JakartaInjectableB.class,
                        JakartaInjectableC.class, JakartaInjectableD.class, JakartaApplicationResource.class, JakartaNonCdiOrEjbInjectable.class)
        );
    }
    ...
    void injectableFieldManipulation(Class<?> producerWithViolations, Class<?> injectableA, Class<?> injectableB,
                                     Class<?> injectableC, Class<?> injectableD, Class<?> resource, Class<?> nonCdiOrEjbInjectable) throws Exception {
        scanClasses(producerWithViolations, injectableA, injectableB, injectableC, injectableD, resource, nonCdiOrEjbInjectable);
    ...
    void injectableOfNonInjectable(Class<?> producerWithViolations, Class<?> injectableA, Class<?> nonInjectable, Class<?> localEjb, Class<?> nonCdiOrEjbInjectable) throws Exception {
        scanClasses(producerWithViolations, injectableA, nonInjectable, localEjb, nonCdiOrEjbInjectable);
    ...
    private static Stream<Arguments> beanProducerAndLocalEjbClasses() {
        return Stream.of(Arguments.of(JavaxBeanProducerWithConstraintViolations.class, JavaxLocalEjb.class, JavaxNonCdiOrEjbInjectable.class),
                Arguments.of(JakartaBeanProducerWithConstraintViolations.class, JakartaLocalEjb.class, JakartaNonCdiOrEjbInjectable.class));
    }
    ...
    void fieldInjectionWithEjb_Violation(Class<?> beanProducerWithViolations, Class<?> localEjb, Class<?> nonCdiOrEjbInjectable) throws Exception {
        scanClasses(beanProducerWithViolations, localEjb, nonCdiOrEjbInjectable);
        ...
        assertThat(fields).haveExactly(1, fieldDescriptor(beanProducerWithViolations, "nonCdiOrEjbInjectable"));
        assertThat(fields).haveExactly(1, fieldDescriptor(beanProducerWithViolations, "nonCdiOrEjbInjectableJdkType"));
